...
interface Props {
    ...
    consultations?: { data: ConsultSummary[] };
}
...
export default function PatientShow({ patient, consultations }: Props) {
                    ...
                    <CardHeader className="flex flex-row items-center justify-between space-y-0">
                        ...
                        <div className="flex items-center gap-2">
                            <Button asChild variant="outline" size="sm">
                                <Link href={`/patients/${p.id}/consultations`}>
                            ...
                            <Button asChild size="sm">
                                <Link
                                    href={`/consultations/create?patient_id=${p.id}`}
                                >
                ...
                <form onSubmit={submit} className="space-y-2">
                    <div className="flex gap-2">
                        ...
                        <Select
                            value={data.severite}
                            onValueChange={(v) =>
                                setData('severite', v as Allergie['severite'])
                            }
                        >
